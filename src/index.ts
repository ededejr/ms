import TimeResolvers, { TimeDelineation } from './time-resolvers';
...
/**
 * Converts a time description such as "2hrs 30mins" to MS;
 *
 * @param timeString The string to convert to milliseconds.
 */
export default function convertTimeDescriptionToMS (timeString: string) {
